...
<style>
	...
	.star.star-48 .star-item{
		...
		margin-right:22px;background-size: 20px 20px;
		background-repeat: no-repeat;
	}
	...
	.star .star-36 .star-item{
		...
		margin-right:16px;background-size: 15px 15px;
	}
	...
	.star .star-24 .star-item{
		...
		margin-right:3px;background-size: 10px 10px;
	}
